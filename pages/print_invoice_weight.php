    ...
    <div class="container-fluid"><br>
        <div class="row">
            <div class="col-sm-12">
                ...
                <a href="<?php echo 'print_invoice_weight_confirm_print.php?id='.$id.'&invoiceNo='.$invoiceNo.''?>" rel="noopener" target="_blank" class="btn btn-success float-right btn-lg mb-3"><i class="fas fa-print"></i> Print</a>
