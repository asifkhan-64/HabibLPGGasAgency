...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Sell List (Qty Based)</h5>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                <?php
                                $retCustomers = mysqli_query($connect, "SELECT customer_summary_qty.*, customer_summary_qty.c_id AS customerID, customer_add.* FROM `customer_summary_qty` 
                                INNER JOIN customer_add ON customer_add.c_id = customer_summary_qty.c_id
                                ORDER BY customer_summary_qty.invoice_id DESC;");
                                $iteration = 1;
                                ...
                                while ($rowCustomers = mysqli_fetch_assoc($retCustomers)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="print_invoice_qty.php?id=' . $rowCustomers['customerID'] . '&invoiceNo=' . $rowCustomers['invoice_id'] . '" type="button" class="btn text-white btn-warning waves-effect waves-light">Print</a></td>
                                    </tr>
                                    ';
                                }
