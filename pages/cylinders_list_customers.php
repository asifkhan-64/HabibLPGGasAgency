...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Customers Cylinder List</h5>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                <?php
                                $retCustomers = mysqli_query($connect, "SELECT cylinder_type_add.*, cylinder_types.*, cylinder_types.cylinder_type AS cyType, customer_add.* FROM `cylinder_type_add`
                                INNER JOIN customer_add ON customer_add.c_id = cylinder_type_add.c_id
                                INNER JOIN cylinder_types ON cylinder_types.cylinder_id = cylinder_type_add.cylinder_type");
                                ...
                                while ($rowCustomers = mysqli_fetch_assoc($retCustomers)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>'   . $rowCustomers['cyType'] . '</td>
                                        <td>'   . $rowCustomers['qty'] . '</td>
                                        <td>'   . substr($rowCustomers['dateauto'], 0, 10) . '</td>';
                                        

                                            // $getCompanyDEtails = mysqli_query($connect, "SELECT * FROM `shop_info`");
                                            // $rowCompanyDetails = mysqli_fetch_assoc($getCompanyDEtails);
                                            // $phone_number = $rowCustomers['customer_contact'];
