...
$getCartItems = mysqli_query($connect, "SELECT cart_tbl_weight.*,cart_tbl_weight.id AS cartID, weight_stock_purchase.*, categories.category_name FROM `cart_tbl_weight`
...
WHERE cart_tbl_weight.c_id = '$c_id' AND cart_tbl_weight.product_id = '$p_id' AND cart_tbl_weight.sell_status = '0'");
...
if (isset($_POST['delete'])) {
    ...
    $deleteQuery = mysqli_query($connect, "DELETE FROM `cart_tbl_weight` WHERE id = '$cart_id' AND product_id = '$product_id'");
    if (!$deleteQuery) {
