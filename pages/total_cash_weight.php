...
if (isset($_POST['generatePdf'])) {
    ...
    $tax_v              = $_POST['tax'];
    $remainingCylinder  = $_POST['remainingCylinder'];
    ...
    $invoiceNo = mysqli_query($connect, "SELECT MAX(invoice_no)AS invoiceNo FROM `customer_weight_invoice`");
    ...
    for ($i = 0; $i < sizeof($arr_cart_id); $i++) {
        ...
        $updateStock = mysqli_query($connect, "UPDATE weight_stock_purchase SET product_qty = (product_qty-'$product_qty') WHERE id = '$product_id'");
        ...
        $updateQuery = mysqli_query($connect, "UPDATE cart_tbl_weight SET sell_status = '1' WHERE product_id = '$product_id' AND c_id = '$c_id' AND id = '$cart_id'");
    ...
    if ($updateCustomerData) {
        ...
        header("LOCATION: print_invoice_weight.php?id=" . $c_id . "&invoiceNo=" . $maxInvoice . "");
    }
}
                            ...
                            <table class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    while ($rowCartItems = mysqli_fetch_assoc($getCartItems)) {
                                        ...
                                        <input type="hidden" name="product_qty[]" step=".01" value="' . $rowCartItems['qty'] . '" class="form-control" required>
                                        ...
                                        <td>' . $iteration++ . '</td>
                                            ...
                                            <td><b>Weight: ' . $rowCartItems['qty'] . '</b>
                                            ';
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td class="text-right"><b>Cylinder:</b></td>
                                        <td><input type="number" placeholder="i.e: 1" name="remainingCylinder" class="form-control pull-right" required=""></td>
                                    </tr>
