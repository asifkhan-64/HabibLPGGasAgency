<?php
    ...
    WHERE qty_stock_purchase.v_id = '$v_id' AND qty_stock_purchase.purchase_date BETWEEN '$start' AND '$end' ORDER BY qty_stock_purchase.id ASC");
    ...
    WHERE weight_stock_purchase.v_id = '$v_id' AND weight_stock_purchase.purchase_date BETWEEN '$start' AND '$end' ORDER BY weight_stock_purchase.id ASC");
...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title d-inline">Vendors Report</h5>
