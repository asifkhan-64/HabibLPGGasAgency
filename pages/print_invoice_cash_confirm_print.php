<?php
    ...
    // --- Database Queries ---
    $getInvoiceItems = mysqli_query($connect, "SELECT customer_qty_invoice.*, customer_qty_invoice.prod_qty AS qty, qty_stock_purchase.*, categories.category_name FROM `customer_qty_invoice`
...
<div id="thermal-receipt">
    ...
    <div style="font-size: 12px;">
        <table>
            <tr><td style="width:30%"><b>Invoice:</b></td><td class="text-right">QT-00<?php echo $invoiceNo; ?></td></tr>
