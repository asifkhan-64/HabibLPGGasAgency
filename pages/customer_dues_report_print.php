<?php
    ...
    // WHERE customer_summary_weight.c_id = '$c_id' AND customer_summary_weight.custom_date BETWEEN '$start' AND '$end' 
    // ORDER BY customer_summary_weight.s_id DESC");
    ...
    // WHERE customer_summary_qty.c_id = '$c_id' AND customer_summary_qty.custom_date BETWEEN '$start' AND '$end' 
    // ORDER BY customer_summary_qty.s_id DESC");
...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title d-inline">Customer Dues Report</h5>
